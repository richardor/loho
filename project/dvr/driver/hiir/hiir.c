...
/*π‹Ω≈∏¥”√øÿ÷∆ºƒ¥Ê∆˜:01£∫IR ‰»Î*/
//#define IOCONFIG  (IO_ADDRESS(0x200f0128)) //Ziven@100224 maybe 3520
#define IOCONFIG  (IO_ADDRESS(0x200f00B4)) //Ziven@100224 3515 ds page 92
...
// 	printk("Enter hiir_read : head=%d, tail=%d, buf_len=%d\n", hiir_dev.head, hiir_dev.tail, hiir_dev.buf_len);
