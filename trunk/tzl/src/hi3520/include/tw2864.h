...
#define TW2864_READ_REG _IOWR('T', 1,int)
#define TW2864_WRITE_REG _IOWR('T', 2,tw2864_w_reg)
#define TW2864_SET_ADA_PLAYBACK_SAMPLERATE  _IOWR('T', 3,int)
#define TW2864_SET_ADA_PLAYBACK_BITWIDTH  _IOWR('T', 4,int) 
#define TW2864_SET_ADA_PLAYBACK_BITRATE   _IOWR('T', 5,int) 
#define TW2864_SET_D1   _IOWR('T', 6,int)
#define TW2864_SET_2_D1     _IOWR('T', 7,tw2864_set_2d1)
#define TW2864_SET_4HALF_D1  _IOWR('T', 8,int)
#define TW2864_SET_4_CIF    _IOWR('T', 9,int)
#define TW2864_SET_AUDIO_OUTPUT     _IOWR('T', 10,int)
#define TW2864_SET_AUDIO_MIX_OUT     _IOWR('T', 11,int)
#define TW2864_SET_AUDIO_RECORD_M  _IOWR('T', 12,int)
#define TW2864_SET_MIX_MUTE     _IOWR('T', 13,int)
#define TW2864_CLEAR_MIX_MUTE   _IOWR('T', 14,int)
#define TW2864_SET_ADA_SAMPLERATE  _IOWR('T', 15,int)
#define TW2864_SET_ADA_BITWIDTH   _IOWR('T', 16,int)
#define TW2864_SET_ADA_BITRATE   _IOWR('T', 17,int)
#define TW2864_SET_VIDEO_MODE _IOWR('T', 18,int)

#define TW2864_GET_ADA_PLAYBACK_SAMPLERATE  _IOWR('T', 19,int)
#define TW2864_GET_ADA_PLAYBACK_BITWIDTH   _IOWR('T', 20,int)
#define TW2864_GET_ADA_PLAYBACK_BITRATE   _IOWR('T', 21,int)
//#define TW2864_GET_D1   _IOWR('T', 22,int)
//#define TW2864_GET_2_D1     _IOWR('T', 23,int)
//#define TW2864_GET_4HALF_D1  _IOWR('T', 24,int)
//#define TW2864_GET_4_CIF    _IOWR('T', 25,int)
#define TW2864_GET_AUDIO_OUTPUT     _IOWR('T', 26,int)
//#define TW2864_GET_AUDIO_MIX_OUT     _IOWR('T', 27,int)
//#define TW2864_GET_AUDIO_RECORD_M   _IOWR('T', 28,int)
//#define TW2864_GET_MIX_MUTE     _IOWR('T', 29,int)
//#define TW2864_GET_MIX_MUTE_CLEAR   _IOWR('T', 30,int)
#define TW2864_GET_ADA_SAMPLERATE  _IOWR('T', 31,int)
#define TW2864_GET_ADA_BITWIDTH   _IOWR('T', 32,int)
#define TW2864_GET_ADA_BITRATE   _IOWR('T', 33,int)
#define TW2864_GET_VIDEO_MODE _IOWR('T', 34,int)
#define TW2864_REG_DUMP  _IOWR('T', 35,int)
...
#define SET_2205K_SAMPLERATE 2//22.5k 
#define SET_24K_SAMPLERATE 3//24k
#define SET_32K_SAMPLERATE 4//32k
#define SET_441K_SAMPLERATE 5//44.1k
#define SET_48K_SAMPLERATE 6//48k

#define SET_8_BITWIDTH 1
#define SET_16_BITWIDTH 0
#define SET_32_BITWIDTH 2
