...
BdUtil.newRelogin = function(){
    var g_jump_url=window.location;
	Space.Libs.bdDialog.showIframe({
			title: "登录到百度空间",
			url: "https://passport.baidu.com/?login&psp_tt=2&tpl=sp&fu="+escape("http://hi.baidu.com/st/loginok.html")+"&u="+escape(g_jump_url),
			width: 400,
			height: 300,
		   displayMode:"normal"
	 });
